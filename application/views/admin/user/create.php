    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php echo form_open(base_url('index.php/admin/user/save'));
                $id_user->jumlah = $id_user->jumlah + 1;
                ?>
                <div class="form-group row">
                    <!-- <label class="col-4 col-form-label" for="nama_faskes">ID Faskes</label> -->
                    <div class="col-8">
                        <div class="input-group">
                            <input id="id_user" value="<?= $id_user->jumlah ?>" name="id_user" type="text" class="form-control" required="required" hidden>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input id="role" name="role" type="text" class="form-control" required="required">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
