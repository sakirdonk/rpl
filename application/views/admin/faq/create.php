    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php
                echo form_open(base_url('index.php/admin/faq/save'));
                ?>
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input id="pertanyaan" name="pertanyaan" type="text" class="form-control" required="required">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input id="jawaban" name="jawaban" type="text" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
